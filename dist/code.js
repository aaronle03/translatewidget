...
(() => {
  ...
  // test.js
  var api_url = "https://655.mtis.workers.dev/translate";
  var params = {
    text: "Dog",
      ...
      /* @__PURE__ */ figma.widget.h(
        ...
        <rect x="0.5" y="0.5" width="29" height="29" rx="14.5" stroke="black" stroke-opacity="0.1"/>
          ...
          onClick: () => __async(this, null, function* () {
            setCount(count + 1);
            const translationResponse = yield (void 0)(textToTranslate, sourceLanguage, targetLanguage);
            if (translationResponse !== null) {
              console.log(`Translation from ${sourceLanguage} to ${targetLanguage}: ${translationResponse}`);
            }
          })
        }
      )
